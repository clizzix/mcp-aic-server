...
server.registerTool(
    'search_artworks',
    {
        ...
        description:
            'Retreive artworks based on a search query and a page number for pagination',
        inputSchema: {
        ...
        try {
            ...
            return {
                content: [
                    {
                        type: 'text',
                        text: `Error: ${error instanceof Error ? error.message : 'Unknown errror occured'}`,
                    },
                ],
            };
        }
...
server.registerResource(
    ...
    'docs://art-institute-of-chicago',
    {
        ...
        description:
            'Full OpenAPI documentation for the Art Institute of Chicago API.',
